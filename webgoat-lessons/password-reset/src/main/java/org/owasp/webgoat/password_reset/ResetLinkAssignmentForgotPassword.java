...
public class ResetLinkAssignmentForgotPassword extends AssignmentEndpoint {
  ...
  public ResetLinkAssignmentForgotPassword(
      RestTemplate restTemplate, @Value("${webwolf.url.mail}") String webWolfMailURL) {
  ...
  public AttackResult sendPasswordResetLink(
    ...
    if (hasText(email)) {
      if (email.equals(ResetLinkAssignment.TOM_EMAIL)
          && (host.contains("9090")
              || host.contains("webwolf"))) { // User indeed changed the host header.
