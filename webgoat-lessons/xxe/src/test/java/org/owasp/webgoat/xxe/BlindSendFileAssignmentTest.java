...
public class BlindSendFileAssignmentTest extends LessonTest {
  ...
  @Rule public WireMockRule webwolfServer = new WireMockRule(wireMockConfig().dynamicPort());
  ...
  public void simpleXXEShouldNotWork() throws Exception {
    ...
    assertThat(comments.getComments())
        .extracting(c -> c.getText())
        .containsAnyOf("Nice try, you need to send the file to WebWolf");
  }
