...
public class Assignment {
  ...
  /**
   * Set path is here to overwrite stored paths. Since a stored path can no longer be used in a
   * lesson while the lesson (name) itself is still part of the lesson.
   *
