 ...
 * </code> Thymeleaf will invoke this resolver based on the prefix and this implementation will
 * resolve the html in the plugins directory
 */
  ...
  protected ITemplateResource computeTemplateResource(
    ...
    if (resource == null) {
      try {
        resource =
            resourceLoader
                .getResource("classpath:/html/" + templateName + ".html")
                .getInputStream()
                .readAllBytes();
      } catch (IOException e) {
        e.printStackTrace();
